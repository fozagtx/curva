 ...
 * IDL can be found at `target/idl/whistle.json`.
 */
export type Whistle = {
  ...
  "metadata": {
    ...
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Whistle: parimutuel World Cup pools settled trustlessly via CPI into TxLINE's TxOracle validate_stat"
  },
  "instructions": [
    {
      "name": "claim",
